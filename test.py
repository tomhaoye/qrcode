...
# Qrcode('测试二维码中间加入图片', 'H').put_img_inside('pic/mystic.png').resize(375).generate('testpic/test9.png')
#
# Qrcode('测试图片填充二维码中间加入图片', 'H').paint('pic/test.jpg').put_img_inside('pic/mystic.png').resize(375).generate('testpic/testA.png')
#
...
Qrcode('试试看gif试试看gif试试看gif试试看gif试试看gif试试看gif试试看', 'H').fill_gif('pic/pla.gif').resize(300).generate('testpic/testD.gif')
